...
(function (root) {
  ...
  var buildings = {
    ...
    // ── North-east: Shadyside around Shady Ave & Walnut St (Kenmawr) ─────────────────────────
    "w170951269": {
      nameZh: "肯莫尔公寓", nameEn: "Kenmawr Apartments", aka: "The Kenmawr",
      built: "1956",
      style: "战后现代主义砖砌公寓楼，十字形平面",
      floors: 8,
      function: "出租公寓（约 245 户）",
      address: "沙迪大道 401 号（401 Shady Avenue）",
      description: "肯莫尔公寓 1956 年落成，是一栋 8 层、约 245 户的橙红砖公寓楼，站在沙迪赛德东缘沙迪大道与胡桃街路口的东南角。它的平面是一个十字，四翼向外伸展，让更多房间朝向街道和树木；大门藏在两翼相交的内角里，门前一道雨篷。隔着胡桃街，北面是加略山圣公会教堂高耸的石尖塔，西北是圣心天主堂敦实的方塔——两座教堂与这栋战后公寓一起，构成了沙迪大道上最有辨识度的街景。",
      facts: [
        "“Kenmawr”带有威尔士语色彩：mawr 意为“大的”，与宾州东部“Bryn Mawr”（大山丘）同源。",
        "楼前沙迪大道与胡桃街转角的一小片草坪，在地图上标作肯莫尔草坪（Kenmawr Field）。",
        "向北步行不到 10 分钟就是东自由的宾大道商圈；沿胡桃街向西走一公里左右，便到沙迪赛德的精品商店街。"
      ],
      tags: ["沙迪赛德", "公寓", "邻近"]
    },

    "w170954640": {
      nameZh: "加略山圣公会教堂", nameEn: "Calvary Episcopal Church",
      built: "1906–1907（会众创立于 1855 年）",
      architect: "拉尔夫·亚当斯·克拉姆（Ralph Adams Cram；Cram, Goodhue & Ferguson 事务所）",
      style: "哥特复兴，印第安纳石灰岩",
      function: "圣公会教堂",
      address: "沙迪大道 315 号",
      description: "加略山圣公会教堂由美国哥特复兴建筑大师拉尔夫·亚当斯·克拉姆设计，1907 年底在沙迪赛德落成，外墙是浅灰的印第安纳石灰岩。教堂长约 63 米，石尖塔从地面到顶端十字架高约 67 米（220 英尺），是沙迪大道一带的地标。1921 年 1 月 2 日，西屋公司的 KDKA 电台在这里直播了晚间礼拜——这被公认为世界上第一次用无线电广播宗教仪式。",
      facts: [
        "会众 1855 年在东自由成立，1907 年迁入现址；钢铁大亨亨利·克莱·弗里克曾慷慨捐助，教堂七年内就还清了建设欠款。",
        "塔内悬挂 11 口梅尼利（Meneely）青铜钟，彩窗出自伦敦的 Heaton, Butler & Bayne 以及美国的康尼克（Connick）等工作室。",
        "2012 年列入美国国家史迹名录。"
      ],
      tags: ["沙迪赛德", "宗教建筑", "哥特复兴", "邻近"]
    },

    "w247904059": {
      nameZh: "圣心天主堂", nameEn: "Sacred Heart Church",
      built: "1924–1953",
      architect: "卡尔顿·斯特朗（Carlton Strong）；其后由 Kaiser, Neal & Reid 事务所续建完成",
      style: "哥特复兴",
      function: "天主教堂区教堂",
      address: "沙迪大道 310 号",
      description: "圣心天主堂与加略山圣公会教堂隔着沙迪大道相望。它 1924 年动工，1926 年就开始在未完工的教堂里举行弥撒，此后又断断续续建了近三十年，直到 1953 年才全部完工。建筑师卡尔顿·斯特朗以欧洲的大教堂为范本，最醒目的是屋顶中部一座方正厚重的石塔，灰色石墙配蓝灰色石板瓦屋顶。",
      facts: [
        "斯特朗 1931 年去世，工程由他的继任事务所 Kaiser, Neal & Reid 完成。",
        "两座教堂一尖一方，站在肯莫尔公寓前就能同时看到。"
      ],
      tags: ["沙迪赛德", "宗教建筑", "哥特复兴", "邻近"]
    },

    "w545286747": {
      nameZh: "亨特军械库", nameEn: "Hunt Armory",
      built: "1916–1918",
      style: "古典复兴，浅色陶砖壁柱立面",
      function: "昔日国民警卫队军械库与大礼堂；今为溜冰场",
      address: "爱默生街 324 号",
      description: "亨特军械库占满整个街区，以美国铝业公司（Alcoa）创始人、曾参加美西战争的阿尔弗雷德·亨特上尉命名。它的正面是一排浅色壁柱，后面是跨度很大的操练大厅。1961 年市民体育馆落成之前，这里是匹兹堡最大的室内会场之一，艾森豪威尔总统和布道家葛培理都曾在此演讲；军方一直用到 2013 年。2022 年，匹兹堡企鹅队与市政府合作把操练大厅改成了公共溜冰场；后来查塔姆大学租下这里，计划改建为全年开放的冰场。",
      facts: [
        "它的名字和卡内基梅隆的亨特图书馆有渊源：图书馆的捐赠人罗伊·亨特正是阿尔弗雷德·亨特之子。",
        "列入美国国家史迹名录。"
      ],
      tags: ["沙迪赛德", "历史", "体育", "邻近"]
    },
    ...
    "w545289249": {
      nameZh: "海兰塔公寓", nameEn: "Highland Towers",
      built: "1913",
      architect: "小弗雷德里克·沙伊布勒（Frederick G. Scheibler Jr.）",
      style: "早期现代主义：黄色毛面砖、深蓝瓷砖与灰泥",
      floors: 4,
      function: "公寓",
      address: "南海兰大道 340–342 号",
      description: "匹兹堡本土建筑师沙伊布勒的代表作。1913 年的美国公寓大多还在堆砌古典装饰，这栋 U 形公寓却已用黄色毛面砖、深蓝色瓷砖和平整的灰泥墙面组成简洁的几何立面；两个入口抬高在街面之上，每户都有朝向中庭花园的阳光房和阳台。当年每层只有四户，每户三间卧室，还配有中央吸尘管道等新奇设备。",
      facts: ["入口处的深蓝艺术瓷砖出自宾州多伊尔斯敦的亨利·默瑟（Henry Mercer）陶瓷工坊。", "1976 年列入美国国家史迹名录。"],
      tags: ["沙迪赛德", "公寓", "建筑史", "邻近"]
    },

    "w257791786": {
      nameZh: "埃利斯女子学校", nameEn: "The Ellis School",
      built: "1916 年创校",
      function: "私立女子预科学校（幼儿园至十二年级）",
      address: "第五大道 6425 号",
      description: "埃利斯学校 1916 年由布林莫尔学院毕业生萨拉·弗雷泽·埃利斯创办，开学时只有 3 位老师、41 名学生，校址借用埃尔斯沃思大道上的租屋；如今是一所从幼儿园到高中的女子预科学校，校园就在肯莫尔公寓东侧。",
      tags: ["沙迪赛德", "中学", "邻近机构"]
    },

    "w257862194": {
      nameZh: "匹兹堡艺术中心", nameEn: "Pittsburgh Center for the Arts",
      built: "1912（原马歇尔宅邸）",
      function: "社区艺术中心：展览、课程与工作室",
      address: "第五大道 6300 号",
      description: "艺术中心设在第五大道与沙迪大道路口的一座 1912 年宅邸里，宅主是钢结构公司 McClintic-Marshall 的总裁查尔斯·马歇尔。它背靠梅隆公园：隔壁原是银行家理查德·B·梅隆的大宅，大宅拆除后，庄园的花园留给了市民。",
      tags: ["沙迪赛德", "艺术", "邻近"]
    },

    "w172201139": {
      nameZh: "查塔姆大学梅隆楼", nameEn: "Andrew W. Mellon Hall, Chatham University",
      built: "1897（劳克林家族宅邸）；1917 年后由安德鲁·梅隆改建",
      function: "查塔姆大学行政楼（校长办公室等）",
      description: "伍德兰路山坡上这座爬满常春藤的宅邸，1897 年为琼斯与劳克林钢铁公司的劳克林家族建造，1917 年被银行家、后来的美国财政部长安德鲁·梅隆买下，加建了网球场、保龄球道和游泳池。1940 年，梅隆之子保罗·梅隆把宅邸捐给当时的宾夕法尼亚女子学院——也就是今天的查塔姆大学，起初用作学生活动中心，如今是校长办公室等行政部门的所在。",
      facts: ["查塔姆大学 1869 年创校，长期是一所女子学院；整个伍德兰路校园同时是一座树木园（Chatham Arboretum）。"],
      tags: ["查塔姆大学", "历史", "邻近"]
    },

    // ── East Liberty: Penn Avenue, Highland Avenue and the old Penn Circle ─────────────────────
    "w34309874": {
      nameZh: "东自由长老会教堂", nameEn: "East Liberty Presbyterian Church", aka: ["希望大教堂", "Cathedral of Hope"],
      built: "1931–1935（现存为该址第五座教堂）",
      architect: "拉尔夫·亚当斯·克拉姆（Ralph Adams Cram）",
      style: "哥特复兴",
      function: "长老会教堂",
      address: "南海兰大道 116 号",
      description: "这座“大教堂尺度”的哥特式教堂占据宾大道与南海兰大道路口的一整个街区，由银行家理查德·比蒂·梅隆与妻子詹妮·金·梅隆全额出资，1935 年母亲节献堂，用以纪念双方的母亲。设计者正是加略山圣公会教堂的建筑师克拉姆。钟塔高约 91 米（300 英尺），是东自由天际线的中心，从周边许多山坡上都能望见。",
      facts: [
        "会众 1819 年成立，建堂土地由东自由的开拓者内格利家族捐出；1819、1847、1862、1887 年和 1935 年，这里先后建起过五座教堂。",
        "梅隆家族与东自由渊源深厚：梅隆银行的创始人托马斯·梅隆娶的正是内格利家的女儿萨拉。",
        "管风琴原为 Æolian-Skinner 所造，彩窗出自康尼克（Connick）与 D'Ascenzo 等名家工作室。"
      ],
      tags: ["东自由", "宗教建筑", "哥特复兴", "地标", "邻近"]
    },

    "w34398651": {
      nameZh: "汽车广场花园", nameEn: "Motor Square Garden", aka: "East Liberty Market House（东自由市场大楼）",
      built: "1898–1900",
      architect: "Peabody & Stearns（波士顿）",
      style: "布扎风格：黄砖山墙大厅与蓝绿色钢框穹顶",
      function: "美国汽车协会（AAA）等机构办公",
      address: "鲍姆大道 5900 号",
      description: "这座黄砖大厅由梅隆家族出资、波士顿事务所 Peabody & Stearns 设计，1900 年作为东自由市场大楼开业，屋顶正中一座包着锡皮的钢框穹顶，如今漆成蓝绿色。市场生意不佳，1915 年匹兹堡汽车协会买下它办车展，改名“汽车广场花园”；二十年代这里是拳击和大学篮球的赛场，匹兹堡大学篮球队在 1925 年之前以此为主场；大萧条时期还举办过持续 35 天的舞蹈马拉松。",
      facts: [
        "20 世纪 80 年代末曾改建为高档购物中心，经营惨淡；此后由美国汽车协会（AAA）使用。",
        "1977 年列入美国国家史迹名录，也是匹兹堡市级历史地标。",
        "所在的鲍姆大道早年是匹兹堡的“汽车一条街”，沿街至今仍有不少车行。"
      ],
      tags: ["东自由", "历史", "地标", "邻近"]
    },

    "w34309462": {
      nameZh: "匹兹堡卡内基图书馆东自由分馆", nameEn: "Carnegie Library of Pittsburgh – East Liberty",
      built: "1905 年开馆；1968 年迁入现址；2009–2010 年翻修扩建",
      architect: "2010 年扩建：EDGE studio（与 Evolve Architecture 合作）",
      function: "公共图书馆",
      address: "南惠特菲尔德街 130 号",
      description: "东自由分馆 1905 年开馆，是安德鲁·卡内基出资兴建的匹兹堡第六座分馆。原来的老馆舍在 60 年代“城市更新”中被拆除，图书馆 1968 年迁到现址；2009 年闭馆翻修扩建，2010 年重新开放：新增的约 840 平方米把儿童、青少年和成人阅览区都放到了一层，深灰色锌板包裹的二层向外挑出，为下面大片的玻璃窗遮挡眩光，整栋楼获得 LEED 银级认证。",
      facts: ["2010 年 8 月的重新开馆周末，有 4700 多人前来参观。"],
      tags: ["东自由", "图书馆", "卡内基", "邻近"]
    },

    "w377411693": {
      nameZh: "海兰大楼", nameEn: "Highland Building",
      built: "1909–1910",
      architect: "丹尼尔·伯纳姆事务所（D. H. Burnham & Co.）",
      style: "芝加哥学派办公楼：浅黄砖墙、白色陶砖基座与檐口",
      floors: 13,
      function: "原为办公楼，今为公寓（约 99 户）",
      address: "南海兰大道 121 号",
      description: "钢铁大亨亨利·克莱·弗里克请芝加哥建筑大师丹尼尔·伯纳姆设计了这栋 13 层办公楼，这是伯纳姆在匹兹堡的最后几件作品之一，也是东自由最高的老建筑。它曾空置约二十年、门窗封死，2010 年代初开发商把它改造成公寓，如今重新住满了人。",
      facts: ["伯纳姆在匹兹堡共有十余件作品，市中心的弗里克大厦也出自他手。"],
      tags: ["东自由", "高楼", "建筑史", "邻近"]
    },

    "w126251317": {
      nameZh: "华莱士大楼", nameEn: "Wallace Building",
      style: "三层商业楼，棕色毛面砖与圆形装饰",
      function: "底层商铺，上层办公",
      description: "海兰大道与森特大道（旧宾环路南段）路口的三层商业楼，棕色毛面砖墙上嵌着一排圆形装饰，底层是墨西哥餐馆等店铺，旁边就是海兰大楼。",
      tags: ["东自由", "商店", "邻近"]
    },

    "w126258077": {
      nameZh: "凯利酒吧", nameEn: "Kelly's Bar & Lounge",
      function: "酒吧（兼营简餐）",
      address: "森特大道 6012 号（原宾环路南段）",
      description: "东自由的老牌鸡尾酒吧，20 世纪 40 年代起以不同名号在此营业，门外那块写着“KELLY'S BAR · LOUNGE · GOOD FOOD”的复古霓虹招牌很好认；店内经过细心修复，仍是四十年代的昏暗电影感。",
      tags: ["东自由", "餐饮", "邻近"]
    },

    "w126258080": {
      nameZh: "巴黎66法式小馆", nameEn: "Paris 66",
      function: "法式小馆",
      address: "森特大道（原宾环路南段）6018 号",
      description: "凯利酒吧隔壁的法式小馆，主打可丽饼和家常法国菜，是东自由商圈里颇受欢迎的一家餐厅。",
      tags: ["东自由", "餐饮", "邻近"]
    },

    "w125708085": {
      nameZh: "塔吉特百货（东自由店）", nameEn: "Target East Liberty",
      built: "2011 年 7 月开业",
      function: "百货超市",
      address: "宾大道 6231 号",
      description: "这家塔吉特 2011 年开业，所在地原本是 60 年代城市更新时建起的保障房高楼 Penn Circle Towers。它是全美少数几家双层塔吉特之一：下层是停车场，卖场在上层。它和早几年开业的家得宝、全食超市一起，被视为东自由商业复兴的标志。",
      tags: ["东自由", "商店", "邻近"]
    },

    "w126268566": {
      nameZh: "乔氏超市（东自由店）", nameEn: "Trader Joe's",
      built: "2006 年秋开业",
      function: "超市",
      address: "宾大道 6343 号",
      description: "匹兹堡的第一家乔氏超市，2006 年在宾大道东段一栋翻修过的单层楼里开业，是不少卡内基梅隆学生周末采购的去处。",
      tags: ["东自由", "商店", "邻近"]
    },

    "w549971972": {
      nameZh: "宾大道 5900 号（多邻国旧总部）", nameEn: "5900 Penn Avenue",
      function: "办公楼",
      address: "宾大道 5900 号（宾大道与南比蒂街路口）",
      description: "这栋三层、约 7 万多平方英尺的办公楼侧墙上画着粉白相间的大壁画，2016 年起是语言学习应用多邻国（Duolingo）的总部。多邻国由卡内基梅隆计算机教授路易斯·冯·安（Luis von Ahn）与他的研究生塞韦林·哈克（Severin Hacker）创办，是卡内基梅隆最成功的衍生公司之一。2026 年公司迁往附近更大的 Liberty East 办公楼，这栋楼随即挂牌招租。",
      facts: ["冯·安也是验证码 CAPTCHA 与 reCAPTCHA 的共同发明人。"],
      tags: ["东自由", "卡内基梅隆", "科技", "邻近"]
    },

    "w440116460": {
      nameZh: "英迪格酒店（东自由）", nameEn: "Hotel Indigo Pittsburgh East Liberty",
      function: "精品酒店（约 135 间客房）",
      address: "北海兰大道 123 号",
      description: "东自由长老会教堂北面的精品酒店，是这一带为数不多的酒店之一，来卡内基梅隆开会、访校的人常住在这里。",
      tags: ["东自由", "酒店", "邻近"]
    }
  };
  ...
  var landmarks = {
    ...
    // ── Streets of the north-east extension (no 3D module; searchable, fly-to targets) ─────────
    walnutStreet: {
      nameZh: "胡桃街商业街", nameEn: "Walnut Street", aka: ["沙迪赛德胡桃街", "Walnut Street, Shadyside"],
      function: "沙迪赛德的主街：精品店、餐馆与咖啡馆",
      description: "胡桃街是沙迪赛德的主街：西起南艾肯大道、东到丹尼斯顿街，约八个街区的平直街道两旁是两三层的老砖楼，底层开着服饰店、珠宝店、面包房、咖啡馆和各国餐馆，既有 Patagonia、lululemon、丝芙兰这样的连锁品牌，也有 1887 年创立的亨尼珠宝等老字号。沙迪赛德原本是富裕人家的住宅区，20 世纪 50 年代起胡桃街才逐渐变成商业街；一度专放独立与外国电影的沙迪赛德影院，让这里聚集过不少艺术家和嬉皮士。",
      facts: [
        "每年夏天有为囊性纤维化研究募款的“Jam on Walnut”街头音乐会；八月的胡桃街艺术节是评审制艺术展，和埃尔斯沃思大道的艺术节暗暗较劲。",
        "从卡内基梅隆校园向东北步行约 20 分钟即到，是学生们最常去的逛街吃饭地点之一，帕梅拉餐馆（Pamela's）的薄煎饼尤其出名。"
      ],
      tags: ["沙迪赛德", "商店", "餐饮", "街道", "邻近"],
      position: [830, 45, -925]
    },

    pennAvenue: {
      nameZh: "宾大道 · 东自由商圈", nameEn: "Penn Avenue (East Liberty)", aka: ["宾大道", "Penn Avenue", "East Liberty", "东自由"],
      function: "东自由的商业主街",
      description: "宾大道是匹兹堡最古老的干道之一，前身是 1816 年开通的匹兹堡—格林斯堡收费公路。它穿过的东自由（East Liberty）到 1950 年前后已是全美销售额最大的非市中心商业区，百货公司、影院和银行林立。60 年代的“城市更新”拆掉了东自由约一半的建筑，把宾大道改成步行街，又在商业区外修了一圈单行的宾环路（Penn Circle），结果商户从 1959 年的 575 家锐减到 1979 年的 98 家。2000 年后，家得宝、全食超市、塔吉特相继进驻，步行街恢复通车，宾环路也在 2024 年全部改回双向并分段更名，老街重新热闹起来。",
      facts: [
        "“East Liberty”里的 liberty 在旧时英语里指城镇边缘的公共牧地——这里最早正是一片放牧的公地，后来由内格利家族发展成村镇。",
        "东自由长老会教堂、海兰大楼、汽车广场花园都在附近；宾大道上的凯利-斯特雷霍恩剧院（原摄政剧院）以两位在匹兹堡长大的艺术家——舞蹈家金·凯利和爵士作曲家比利·斯特雷霍恩——命名。",
        "卡内基梅隆的衍生公司多邻国（Duolingo）2016–2026 年把总部设在宾大道 5900 号。"
      ],
      tags: ["东自由", "商店", "餐饮", "街道", "历史", "邻近"],
      position: [1650, 43, -1995]
    }
  };
  ...
  var areas = {
    ...
    "Kenmawr Field": {
      nameZh: "肯莫尔草坪", nameEn: "Kenmawr Field",
      description: "肯莫尔公寓西北角、沙迪大道与胡桃街转角的一小片草坪。站在这里抬头，北面是加略山圣公会教堂约 67 米高的石尖塔，西北是圣心天主堂的方塔。",
      tags: ["沙迪赛德", "草坪", "邻近"]
    },

    "Mellon Park": {
      nameZh: "梅隆公园", nameEn: "Mellon Park",
      built: "1943 年捐作市立公园",
      description: "梅隆公园原是银行家理查德·比蒂·梅隆与妻子詹妮·金·梅隆的庄园，他们那座六十多个房间的大宅曾是匹兹堡最大的私人住宅。大宅在 1940 年拆除，1943 年子女理查德·金·梅隆和萨拉·梅隆·斯凯夫把庄园捐给市政府。园中保留着文艺复兴式的围墙花园，匹兹堡艺术中心和菲普斯花园中心也在公园里。",
      facts: ["出资兴建东自由长老会教堂的，正是这对梅隆夫妇。"],
      tags: ["公园", "沙迪赛德", "历史", "邻近"]
    },

    "Walled Garden": {
      nameZh: "梅隆公园围墙花园", nameEn: "Mellon Park Walled Garden",
      built: "1929 年（Vitale & Geiffert 设计）；2010 年修复",
      description: "这座约半英亩的文艺复兴式花园原在梅隆庄园大宅之后，1929 年由当时首屈一指的景观事务所 Vitale & Geiffert 设计。2010 年匹兹堡公园保护协会完成修复，重铺步道、整修喷泉与座椅，并加入艺术家珍妮特·茨威格（Janet Zweig）的纪念装置：地面嵌入的点点 LED 灯，再现了一个特定时刻匹兹堡上空的星图。",
      tags: ["花园", "公园", "沙迪赛德", "邻近"]
    }
  };
  ...
  var tour = [
    ...
    {
      key: "oaklandFinale",
      title: "奥克兰文化区", titleEn: "Oakland's Cultural Heart",
      text: "卡内基梅隆的西邻是匹兹堡的奥克兰文化区。163 米高的学习大教堂是西半球最高的教育建筑，旁边是彩窗高约 22 米的亨氏纪念教堂；卡内基博物馆门前那只真实大小的梁龙 Dippy，纪念的正是卡内基资助发现的恐龙化石。钢铁、慈善与知识在这里交汇。接下来我们掉头向东，去看看学生们周末常去的沙迪赛德和东自由。",
      target: [-730, 107.9, -110], position: [-480, 148.1, -240], duration: 18
    },
    {
      key: "kenmawr",
      title: "沙迪赛德：沙迪大道与肯莫尔公寓", titleEn: "Shadyside: Kenmawr on Shady Avenue",
      text: "从校园向东北两公里多，就到了林荫浓密的沙迪赛德，这里是两所大学许多研究生喜欢租房的街区。画面右侧那栋十字形的橙红砖楼是 1956 年落成的肯莫尔公寓，8 层、约 245 户。隔着胡桃街，它北面是拉尔夫·亚当斯·克拉姆设计的加略山圣公会教堂——1921 年，世界上第一次宗教仪式的电台直播就从这里发出；沙迪大道对面则是前后建了近三十年的圣心天主堂。远处天际线上那座哥特式钟塔所在的地方，已是东自由。",
      target: [1760, 58, -1450], position: [1745, 105, -1180], duration: 18
    },
    {
      key: "eastLiberty",
      title: "终章：东自由与宾大道", titleEn: "Finale: East Liberty & Penn Avenue",
      text: "再往北几个街区就是东自由。正中的哥特式大教堂是梅隆夫妇出资、1935 年落成的东自由长老会教堂，钟塔高约 91 米；它右后方 13 层的海兰大楼出自芝加哥建筑大师伯纳姆之手，近处的黄砖大厅则是 1900 年建成的汽车广场花园，最早是一座菜市场。教堂北侧的宾大道在 1950 年前后是全美最繁华的社区商业街之一，经历“城市更新”的衰落后，如今塔吉特、乔氏超市、老牌的凯利酒吧和各色餐馆让它重新热闹起来，卡内基梅隆孵化的多邻国也曾把总部设在这里。旅程到此结束——欢迎继续自由探索！",
      target: [1490, 68, -2000], position: [1250, 100, -1775], duration: 20
    }
  ];
  ...
  var landmarkBuildings = {
    ...
    // north-east extension (src/landmarks/kenmawr.js, pennAve.js)
    kenmawr: "w170951269", calvary: "w170954640", calvaryEpiscopal: "w170954640", sacredHeart: "w247904059",
    eastLibertyPresbyterian: "w34309874", motorSquareGarden: "w34398651", highlandBuilding: "w377411693",
    wallaceBuilding: "w126251317", clpEastLiberty: "w34309462", targetEastLiberty: "w125708085"
  };
